    ...
    return(
      ...
      <content>
        <div className="mainContentBox">
          ...
          <form action="http://localhost:4000/savestuff" method='post' className="addNewItemForm">
            ...
            <div className="addFormButton"><input type="submit" value="Submit" id="addSubmitButton"/></div>
          </form>
        </div>
      </content>
      <footer>
